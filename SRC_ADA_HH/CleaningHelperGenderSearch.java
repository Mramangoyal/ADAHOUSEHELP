...
/**
 * Servlet implementation class CleaningHelperGenderSearch
 */
@WebServlet("/CleaningHelperGenderSearch")
public class CleaningHelperGenderSearch extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CleaningHelperGenderSearch() {
        super();
